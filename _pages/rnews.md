---
layout: archive
title: <span style="font-size:19px;">Recent News</span>
permalink: /rnews/
author_profile: true
# redirect_from:
#   - /resume
...
<a class="text-btn" href="../allnews/" style="
    ...
    font-weight: 800;          /* 加粗（常规500→加粗600/700） */
    font-size: 16px;
    letter-spacing: 0px;
    position: relative;
    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
">
    Read More <span style="margin-left: 1px;">>></span>
    <!-- <span style="
        position: absolute;
        bottom: 0;
        left: 0;
